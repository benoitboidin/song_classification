...
def load_data(train_filename='train_id_genres_vgg.pickle', test_filename='test_id_vgg.pickle'):
...
if __name__ == '__main__': 
    ...
    x_train, y_train, x_test, ids = load_data('data/train_id_genres_vgg.pickle', 
